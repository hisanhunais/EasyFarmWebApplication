        ...
        <div class="row">
            <div class="col-md-3">
                <!--<div class="list-group">
                    ...
                    <a href="fertilizerOrder.php" id="fertilizerOrderBtn" class="list-group-item active main-color-bg"><span class="glyphicon glyphicon-list-alt" aria-hidden="true"></span> Fertilizer Orders</a>
