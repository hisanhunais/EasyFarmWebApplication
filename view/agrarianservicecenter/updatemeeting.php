      ...
      <div class="col-md-9">
          ...
          <div class="modal-content">
                                      <div class="modal-header">
                                        ...
                                        <h4 class="modal-title" id="addLabel"><center>Update Meetings</center></h4>
                                      </div>
                                      ...
                                      <div class="modal-body">
                                          ...
                                          <div class="form-group">
                                            ...
                                            <input type="label" name="meetingid" class="form-control"  id="meetingid" value=<?php echo $_GET['meetingid']; ?>>
                                          </div>
                                          <div class="form-group">
