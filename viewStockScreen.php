        ...
        <div class="row">
            <div class="col-md-3">
                <div class="list-group">
                    <a href="homefe" class="list-group-item">
                        <span class="glyphicon glyphicon-home" aria-hidden="true"></span> Home
                    </a>
                    <a href="viewStockScreen.php" class="list-group-item  active main-color-bg"><span class="glyphicon glyphicon-grain" aria-hidden="true"></span> Stock</a>
			...
			<div class="col-md-9">
					<div class="panel panel-default">
					  ...
					  <div class="panel-body">
							<button type="button" class="btn btn-secondary" style="float='right'"><a href="addStockScreen.php">Add New Stock</a></button>
							<?php include 'view/viewStock.php';?>
